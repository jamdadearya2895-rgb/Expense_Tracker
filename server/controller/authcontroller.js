...
// CHANGED: imported `hashPassword` instead of `hashedPassword`
...
export const signupUser = async (req, res) => {
  try {
    ...
    // CHANGED: now correctly calls `hashPassword` (renamed function)
    ...
    user.rows[0].password = undefined; // don't send password to client
